    ...
    return (
        <aside
          ...
          <div className="sidenav-header">
            ...
            <a className="navbar-brand m-0" href="https://www.transporte.gob.hn/" target="_blank" rel="noreferrer">
              <img src="../assets/img/results.svg" className="navbar-brand-img h-100" alt="main_logo" />
              <span className="ms-1 font-weight-bold">Estadisticas Ventanilla</span>
            </a>
          </div>
              ...
              {inicioSesion? (<>
                <li className="nav-item">
                  <NavLink exact to="/Reportes" className="nav-link">
                    ...
                    <span className="nav-link-text ms-1">Reportes por Regional</span>
                  </NavLink>
                </li>
                ...
                <li className="nav-item">
                  <NavLink exact to="/Reporte" className="nav-link">
                    ...
                    <span className="nav-link-text ms-1">Mi Reporte</span>
                  </NavLink>
                </li>
              </>) : (
              <div className="sidenav-footer mx-3 mt-3">
                <div className="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                  <div className="full-background"
                    style={{backgroundImage: "url('../assets/img/curved-images/curved14.jpg')"}}></div>
                  <div className="card-body text-start p-3 w-100">
                    <div
                      ...
                      <i className="fas fa-sign-in-alt text-dark text-gradient text-lg top-0" aria-hidden="true"
                        id="sidenavCardIcon"></i>
                    </div>
                    <div className="docs-info">
                      <h6 className="text-white up mb-0">Generar sus reportes?</h6>
                      <p className="text-xs font-weight-bold">para obtener su reporte personal o regional debe iniciar sesión</p>
                      <Link to="/Login" exact className="btn btn-white btn-sm w-100 mb-0">Iniciar sesión</Link>
                    </div>
                  </div>
                </div>
              </div>
